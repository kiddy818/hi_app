...
/** error level */
typedef enum otAPP_ERR_LEVEL_E {
...
#define OT_APP_DEF_ERR(module, level, errid) \
    ((TD_S32)((OT_ERR_APP_APPID) | ((module) << 16) | ((level) << 13) | (errid)))

#define OT_EXT_APP_DEF_ERR(module, level, errid) \
    ((TD_S32)((OT_ERR_EXT_APP_APPID) | ((module) << 16) | ((level) << 13) | (errid)))
