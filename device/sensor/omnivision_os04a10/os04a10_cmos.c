...
const os04a10_video_mode_tbl g_os04a10_mode_tbl[OS04A10_MODE_BUTT] = {
    ...
    {OS04A10_VMAX_4M_30FPS_12BIT_2TO1_WDR,  OS04A10_FULL_LINES_MAX_2TO1_WDR, 30, 10.0,
     2688, 1520, 0, OT_WDR_MODE_2To1_LINE,  "OS04A10_4M_30FPS_10BIT_2TO1_VC_MODE"},
};
...
{
    td_u32 fl = OS04A10_VMAX_4M_30FPS_12BIT_LINEAR;

    if (sns_state->img_mode == OS04A10_4M_30FPS_10BIT_2TO1_VC_MODE) {
        fl = OS04A10_VMAX_4M_30FPS_12BIT_2TO1_WDR;
    }
...
static td_void cmos_fps_set(ot_vi_pipe vi_pipe, td_float fps, ot_isp_ae_sensor_default *ae_sns_dft)
{
    ...
    if ((fps > max_fps) || (fps < min_fps)) {
        isp_err_trace("ISP sensor os04a10 Not support Fps: %f\n", fps);
        return;
    }
...
static td_void cmos_get_isp_dng_default(const ot_isp_sns_state *sns_state, ot_isp_cmos_default *isp_def)
{
    ...
    switch (sns_state->img_mode) {
        ...
        case OS04A10_4M_30FPS_10BIT_2TO1_VC_MODE:
            isp_def->sns_mode.dng_raw_format.bits_per_sample = 12; /* 12bit */
            isp_def->sns_mode.dng_raw_format.white_level = 4095; /* max 4095 */
            break;
